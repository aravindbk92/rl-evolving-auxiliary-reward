...
plt.errorbar(range(1,mean_rewards.size+1),mean_rewards,color='#4682B4FF',ecolor='#4682B455',errorevery=2,yerr=std_rewards,label="DQN")
...
mean_rewards = np.average(episode_reward_trials,axis=0)    
std_rewards = np.std(episode_reward_trials,axis=0)
plt.errorbar(range(1,mean_rewards.size+1),mean_rewards,color='darkorange',ecolor='#FF8C0055',errorevery=2,yerr=std_rewards,label="DQN-evoReward, pop: "+str(POPULATION))
